...
/*--------------------------开始实现第一步------------------------------------*/
	 ...
	 */
	private static void setParsePath(boolean end,String ele,boolean 
			propertyValue,Map<String,ParserModel> mapPath){
...
/*--------------------------开始实现第二步------------------------------------*/
	...
	/**
	 * 把分解出来的元素名称根据对应的解析模型转换成为相应的解析器对象
